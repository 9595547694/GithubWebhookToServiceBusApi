...
builder.Services.AddScoped<ServiceBusSecrets>();
builder.Services.AddScoped<IRepositories<JsonObject>, ServiceRepository>(x=>new ServiceRepository(x.GetRequiredService<ServiceBusSecrets>()));
